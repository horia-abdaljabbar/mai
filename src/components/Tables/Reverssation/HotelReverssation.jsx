...
const HotelReservationTable = ({ data }) => {
    ...
    <div className="-my-2 py-2 w-full overflow-hidden sm:-mx-6 sm:px-2 lg:-mx-8 pr-10 lg:px-8">
      ...
      <div className="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
        <table className="min-w-full">
          <thead>
            <tr>
            <th className="px-2 py-3 border-b-2 border-gray-300 text-right text-sm leading-4 text-black-500 tracking-wider">اسم الفندق</th>
              <th className="px-2 py-3 border-b-2 border-gray-300 text-right text-sm leading-4 text-black-500 tracking-wider">تقييم الفندق</th>
              <th className="px-2 py-3 border-b-2 border-gray-300 text-right text-sm leading-4 text-black-500 tracking-wider"> الدولة </th>
              <th className="px-2 py-3 border-b-2 border-gray-300 text-right text-sm leading-4 text-black-500 tracking-wider"> المدينة </th>
              <th className="px-2 py-3 border-b-2 border-gray-300 text-right text-sm leading-4 text-black-500 tracking-wider"> المنطقة</th>
              
              <th className="px-2 py-3 border-b-2 border-gray-300 text-right text-sm leading-4 text-black-500 tracking-wider">  الرابط الالكتروني</th>

              <th className="px-2 py-3 border-b-2 border-gray-300 text-right text-sm leading-4 text-black-500 tracking-wider"> رابط الحجز </th>
                            <th className="px-2 py-3 border-b-2 border-gray-300 text-right text-sm leading-4 text-black-500 tracking-wider">  المسافه من المركز</th>
                            <th className="px-2 py-3 border-b-2 border-gray-300 text-right text-sm leading-4 text-black-500 tracking-wider">  وصف المسافة  </th>
...
/>
                        ...
                        <Rating name="read-only" value={   row.HotelRating} readOnly />
  ...
  {editRowIndex === index ? (
    ...
    <div className="flex justify-center items-center h-full">
      <button
        title={row.HotelURL} // Tooltip displaying the URL
        onClick={() => window.open(row.HotelURL, '_blank')} // Opens URL in a new tab
      >
        <svg
