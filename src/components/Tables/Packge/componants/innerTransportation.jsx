...
import TrainMenu from "./metromenu";

export default function InnerTransportationSelection() {
    ...
    <div className="space-y-6 mt-6">
      ...
      <div className="flex justify-center mb-4">
        ...
        <Button
          color="black"
          size="sm"
          onClick={() => handleSelectTransport("train")}
          className="mx-2 w-1/3"
        >
          قطار
        </Button>
      ...
      {selectedTransport === "train" && (
        <TrainMenu closeMenu={closeMenu} onSelectOption={handleSelectOption} selectedOption={selectedOption} />
      )}
    </div>
  );
}
